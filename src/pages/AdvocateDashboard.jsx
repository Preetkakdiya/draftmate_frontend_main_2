...
export default function AdvocateDashboard() {
    ...
    const { percentage: completionScore, missingFields = [] } = calculateProfileCompletion({
        ...profile,
        profile_image_url: profile?.profile_image_url || imagePreview,
        imagePreview: imagePreview,
        practice_areas: practiceAreas && practiceAreas.length > 0 ? practiceAreas : profile?.practice_areas
    });
